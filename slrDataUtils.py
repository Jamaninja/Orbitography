# Class adapted from GorgiAstro on github:
# https://github.com/GorgiAstro/laser-orbit-determination/blob/master/slrDataUtils.py
...
from org.orekit.files.ilrs import CRDParser # type: ignore
...
class SlrDlManager:
    ...
    def __init__(self, username_edc: str, password_edc: str, data_type: str, url: str = "https://edc.dgfi.tum.de/api/v1/"):
